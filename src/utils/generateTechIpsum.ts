...
for (let i = 0; i < paragraphs; i++) {
    ...
    for (let j = 0; j < wordsPerParagraph; j++) {
        ...
        if(Math.random() < 0.1) {
            adjective = adjectives[Math.floor(Math.random() * adjectives.length)] + ' and ' + adjectives[Math.floor(Math.random() * adjectives.length)];
        }
        else{
            adjective = adjectives[Math.floor(Math.random() * adjectives.length)];
        }
        const interposition = interpositions[Math.floor(Math.random() * interpositions.length)];
